...
#let doc(body, bibliography-file: "references.bib") = {
  ...
  let title = "Численные методы решения дифференциальных уравнений с сильным вырождением"
  ...
  set page(footer: none, numbering: "1")
...
$
  ...
  exists x_0,t_0 in Omega times T: b(x_0,t_0) = 0
$
